...
public class MBPGunItem extends TimelessGunItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add((new TranslationTextComponent("info.tac.damage", TextFormatting.GOLD + ItemStack.DECIMALFORMAT.format((double) additionalDamage) + additionalDamageText)).mergeStyle(TextFormatting.DARK_GRAY));
        if (tagCompound != null) {
