...
@OnlyIn(Dist.CLIENT)
public class Glock17AnimationController extends PistolAnimationController {
    ...
    public static final AnimationMeta INSPECT_EMPTY = new AnimationMeta(new ResourceLocation("tac","animations/glock_17_inspect.gltf"));
