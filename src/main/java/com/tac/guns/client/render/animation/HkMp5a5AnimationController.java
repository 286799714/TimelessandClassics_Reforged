...
public class HkMp5a5AnimationController extends GunAnimationController {
    ...
    public static final AnimationMeta STATIC = new AnimationMeta(new ResourceLocation("tac","animations/hk_mp5a5_static.gltf"));
    public static final AnimationMeta RELOAD_NORM = new AnimationMeta(new ResourceLocation("tac","animations/hk_mp5a5_reload_norm.gltf"));
    ...
    private HkMp5a5AnimationController(){
        ...
        enableStaticState();
        GunAnimationController.setAnimationControllerMap(ModItems.HK_MP5A5.getId(),this);
    }

    public static HkMp5a5AnimationController getInstance(){
        return instance;
    }
    ...
    public AnimationSoundMeta getSoundFromLabel(AnimationLabel label){
        return super.getSoundFromLabel(ModItems.HK_MP5A5.get(), label);
    }
