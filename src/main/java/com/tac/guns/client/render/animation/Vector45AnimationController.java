...
public class Vector45AnimationController extends GunAnimationController {
    ...
    public static final AnimationMeta RELOAD_NORM = new AnimationMeta(new ResourceLocation("tac","animations/vector45_reload_norm.gltf"));
    ...
    public static final AnimationMeta INSPECT_EMPTY = new AnimationMeta(new ResourceLocation("tac","animations/vector45_inspect_empty.gltf"));
