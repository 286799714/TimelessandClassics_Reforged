...
public class M1A1AnimationController extends GunAnimationController {
    ...
    public static final AnimationMeta STATIC = new AnimationMeta(new ResourceLocation("tac","animations/m1a1_smg_static.gltf"));
    public static final AnimationMeta RELOAD_NORM = new AnimationMeta(new ResourceLocation("tac","animations/m1a1_smg_reload_norm.gltf"));
