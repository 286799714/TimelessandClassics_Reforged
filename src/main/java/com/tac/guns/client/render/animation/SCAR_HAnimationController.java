...
@OnlyIn(Dist.CLIENT)
public class SCAR_HAnimationController extends GunAnimationController{
    ...
    public static final AnimationMeta INSPECT_EMPTY = new AnimationMeta(new ResourceLocation("tac","animations/scar_h_inspect_empty.gltf"));
    public static final AnimationMeta STATIC = new AnimationMeta(new ResourceLocation("tac","animations/scar_h_static.gltf"));
    private static final SCAR_HAnimationController instance = new SCAR_HAnimationController();

    private SCAR_HAnimationController() {
        try {
        ...
        enableStaticState();
        GunAnimationController.setAnimationControllerMap(ModItems.SCAR_H.getId(),this);
    }

    public static SCAR_HAnimationController getInstance(){
        return instance;
    }
    ...
    public AnimationSoundMeta getSoundFromLabel(AnimationLabel label){
        return super.getSoundFromLabel(ModItems.SCAR_H.get(), label);
    }
