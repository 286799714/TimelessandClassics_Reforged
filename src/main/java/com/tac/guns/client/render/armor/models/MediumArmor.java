...
public class MediumArmor extends ArmorBase {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "mediumarmor"), "main");
	private final ModelPart Bulletproofvest_2;

	public MediumArmor() {
		this.Bulletproofvest_2 = createBodyLayer().bakeRoot();
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Bulletproofvest_2 = partdefinition.addOrReplaceChild("Bulletproofvest_2", CubeListBuilder.create().texOffs(0, 14).addBox(-4.0F, -20.0F, -3.5F, 8.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r1 = Bulletproofvest_2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(29, 0).addBox(-3.0F, -1.5F, -0.5F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -21.4033F, -2.7715F, -0.1571F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Bulletproofvest_2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(51, 11).addBox(-0.0799F, -1.0F, 1.0427F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.3125F)), PartPose.offsetAndRotation(0.0F, -23.8125F, 3.6309F, 0.9055F, 0.9798F, 0.8137F));

		PartDefinition cube_r3 = Bulletproofvest_2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(42, 23).addBox(-2.0F, -1.0F, -0.2403F, 4.0F, 2.0F, 1.0F, new CubeDeformation(-0.3125F)), PartPose.offsetAndRotation(0.0F, -23.8125F, 3.6309F, 0.4538F, 0.0F, 0.0F));

		PartDefinition cube_r4 = Bulletproofvest_2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(18, 50).addBox(-2.9201F, -1.0F, 1.0427F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.3125F)), PartPose.offsetAndRotation(0.0F, -23.8125F, 3.6309F, 0.9055F, -0.9798F, -0.8137F));

		PartDefinition bone8 = Bulletproofvest_2.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(29, 23).addBox(0.75F, -18.875F, -5.4375F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.375F))
		...
		PartDefinition bone3 = Bulletproofvest_2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(35, 38).addBox(-0.9477F, -1.6202F, -0.5636F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.1875F))
		...
		PartDefinition bone4 = Bulletproofvest_2.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(37, 31).addBox(-0.9826F, -1.6202F, -0.566F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.1875F))
		...
		PartDefinition bone = Bulletproofvest_2.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 25).addBox(4.1875F, -17.6875F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(-0.1875F))
				.texOffs(19, 0).addBox(4.875F, -17.375F, -2.5F, 2.0F, 5.0F, 5.0F, new CubeDeformation(-0.125F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition bone5 = Bulletproofvest_2.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(44, 38).addBox(-0.875F, -3.5F, -2.375F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.1875F))
		...
		PartDefinition bone6 = Bulletproofvest_2.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(9, 41).addBox(-0.875F, -3.5F, -2.375F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.1875F))
		...
		PartDefinition bone2 = Bulletproofvest_2.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offsetAndRotation(3.6727F, -23.6804F, -0.1056F, 0.0F, 0.0F, -0.0175F));
		...
		PartDefinition bone7 = Bulletproofvest_2.addOrReplaceChild("bone7", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.6727F, -23.6804F, -0.1056F, 0.0F, 0.0F, 0.0175F));
		...
		PartDefinition bone9 = Bulletproofvest_2.addOrReplaceChild("bone9", CubeListBuilder.create().texOffs(51, 45).addBox(-0.2579F, -0.4644F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)), PartPose.offsetAndRotation(-6.5745F, -15.507F, -3.6935F, 0.5342F, -0.1943F, 1.4105F));
		...
		PartDefinition bone10 = Bulletproofvest_2.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(11, 25).addBox(-0.2579F, -0.4644F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.125F)), PartPose.offsetAndRotation(-7.0745F, -15.882F, -0.3185F, 0.812F, -0.138F, 1.4072F));
