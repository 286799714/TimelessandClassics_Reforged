...
public class AnimationAssetLoader {
    public static AnimationOnlyGltfAsset loadGltfAnimationAsset(ResourceLocation resourceLocation) throws IOException {
        ...
        Gson gson = new Gson();
        return gson.fromJson(json, AnimationOnlyGltfAsset.class);
    }
}
