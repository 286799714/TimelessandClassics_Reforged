...
public class SkinLoader {
    ...
    @SubscribeEvent
    public static void onBakeryProcess(ModelBakeryProcessLoadingEvent event){
        missingModel = event.missingModel;
        unbakedModels = event.unbakedCache;
        topUnbakedModels = event.topLevelModels;
    }
