...
"Cannot deserialize instance of %s out of %s token: nested Arrays not allowed with %s",
     ...
     * is to be deserialized: result of this method will be {@link Boolean},
     ...
     * since those values could be of type other than {@link Boolean}.
            ...
            throws IOException
    {
        ...
        return (Date) ctxt.handleUnexpectedToken(_valueClass, JsonToken.START_ARRAY, p, null);
    }
